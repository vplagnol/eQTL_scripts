...
dataset="GTex"
conditions="Thyroid WholeBlood Muscle Nerve SkinSunExposedLowerleg Lung ArteryTibial HeartLeftVentricle AdiposeSubcutaneous"
#conditions="Brain"
...
###### cis eQTLs first
my.tab <- run.eQTL ( dataset, condition, chromosome = as.character($chromosome), start = 1, end = 300*10^6, pvOutputThreshold = 1e-5, force = TRUE, min.MAF = 0.05)
